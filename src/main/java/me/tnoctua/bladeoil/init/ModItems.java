...
public class ModItems {
    ...
    public static final ArrayList<EntityType<?>> HOLY_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> INSECTOID_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> DAVY_JONES_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> ENDSPAWN_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> HANGED_MAN_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> RELICT_OIL_ENTITIES = new ArrayList<>();
    public static final ArrayList<EntityType<?>> HELLSPAWN_OIL_ENTITIES = new ArrayList<>();
    ...
    public static final Item HOLY_OIL = REGISTRY.register("holy_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("holy", BladeOilConfig.holyOilDamage,
                    BladeOilConfig.holyOilQuality, HOLY_COLOR, HOLY_OIL_ENTITIES)));
    public static final Item ENHANCED_HOLY_OIL = REGISTRY.register("enhanced_holy_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_holy", BladeOilConfig.enhancedHolyOilDamage,
                    BladeOilConfig.enhancedHolyOilQuality, HOLY_COLOR, HOLY_OIL_ENTITIES)));
    public static final Item SUPERIOR_HOLY_OIL = REGISTRY.register("superior_holy_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_holy", BladeOilConfig.superiorHolyOilDamage,
                    BladeOilConfig.superiorHolyOilQuality, HOLY_COLOR, HOLY_OIL_ENTITIES)));
    ...
    public static final Item INSECTOID_OIL = REGISTRY.register("insectoid_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("insectoid", BladeOilConfig.insectoidOilDamage,
                    BladeOilConfig.insectoidOilQuality, INSECTOID_COLOR, INSECTOID_OIL_ENTITIES)));
    public static final Item ENHANCED_INSECTOID_OIL = REGISTRY.register("enhanced_insectoid_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_insectoid", BladeOilConfig.enhancedInsectoidOilDamage,
                    BladeOilConfig.enhancedInsectoidOilQuality, INSECTOID_COLOR, INSECTOID_OIL_ENTITIES)));
    public static final Item SUPERIOR_INSECTOID_OIL = REGISTRY.register("superior_insectoid_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_insectoid", BladeOilConfig.superiorInsectoidOilDamage,
                    BladeOilConfig.superiorInsectoidOilQuality, INSECTOID_COLOR, INSECTOID_OIL_ENTITIES)));
    ...
    public static final Item DAVY_JONES_OIL = REGISTRY.register("davy_jones_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("davy_jones", BladeOilConfig.davyJonesOilDamage,
                    BladeOilConfig.davyJonesOilQuality, DAVY_JONES_COLOR, DAVY_JONES_OIL_ENTITIES)));
    ...
    public static final Item ENDSPAWN_OIL = REGISTRY.register("endspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("endspawn", BladeOilConfig.endspawnOilDamage,
                    BladeOilConfig.endspawnOilQuality, ENDSPAWN_COLOR, ENDSPAWN_OIL_ENTITIES)));
    public static final Item ENHANCED_ENDSPAWN_OIL = REGISTRY.register("enhanced_endspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_endspawn", BladeOilConfig.enhancedEndspawnOilDamage,
                    BladeOilConfig.enhancedEndspawnOilQuality, ENDSPAWN_COLOR, ENDSPAWN_OIL_ENTITIES)));
    public static final Item SUPERIOR_ENDSPAWN_OIL = REGISTRY.register("superior_endspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_endspawn", BladeOilConfig.superiorEndspawnOilDamage,
                    BladeOilConfig.superiorEndspawnOilQuality, ENDSPAWN_COLOR, ENDSPAWN_OIL_ENTITIES)));
    ...
    public static final Item HANGED_MAN_OIL = REGISTRY.register("hanged_man_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("hanged_man", BladeOilConfig.hangedManOilDamage,
                    BladeOilConfig.hangedManOilQuality, HANGED_MAN_COLOR, HANGED_MAN_OIL_ENTITIES)));
    public static final Item ENHANCED_HANGED_MAN_OIL = REGISTRY.register("enhanced_hanged_man_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_hanged_man", BladeOilConfig.enhancedHangedManOilDamage,
                    BladeOilConfig.enhancedHangedManOilQuality, HANGED_MAN_COLOR, HANGED_MAN_OIL_ENTITIES)));
    public static final Item SUPERIOR_HANGED_MAN_OIL = REGISTRY.register("superior_hanged_man_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_hanged_man", BladeOilConfig.superiorHangedManOilDamage,
                    BladeOilConfig.superiorHangedManOilQuality, HANGED_MAN_COLOR, HANGED_MAN_OIL_ENTITIES)));
    ...
    public static final Item RELICT_OIL = REGISTRY.register("relict_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("relict", BladeOilConfig.relictOilDamage,
                    BladeOilConfig.relictOilQuality, RELICT_COLOR, RELICT_OIL_ENTITIES)));
    public static final Item ENHANCED_RELICT_OIL = REGISTRY.register("enhanced_relict_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_relict", BladeOilConfig.enhancedRelictOilDamage,
                    BladeOilConfig.enhancedRelictOilQuality, RELICT_COLOR, RELICT_OIL_ENTITIES)));
    public static final Item SUPERIOR_RELICT_OIL = REGISTRY.register("superior_relict_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_relict", BladeOilConfig.superiorRelictOilDamage,
                    BladeOilConfig.superiorRelictOilQuality, RELICT_COLOR, RELICT_OIL_ENTITIES)));
    ...
    public static final Item HELLSPAWN_OIL = REGISTRY.register("hellspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("hellspawn", BladeOilConfig.hellspawnOilDamage,
                    BladeOilConfig.hellspawnOilQuality, HELLSPAWN_COLOR, HELLSPAWN_OIL_ENTITIES)));
    public static final Item ENHANCED_HELLSPAWN_OIL = REGISTRY.register("enhanced_hellspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("enhanced_hellspawn", BladeOilConfig.enhancedHellspawnOilDamage,
                    BladeOilConfig.enhancedHellspawnOilQuality, HELLSPAWN_COLOR, HELLSPAWN_OIL_ENTITIES)));
    public static final Item SUPERIOR_HELLSPAWN_OIL = REGISTRY.register("superior_hellspawn_oil", BladeOilItem::new, new Item.Settings()
            ...
            .component(ModComponents.BLADE_OIL, new BladeOilComponent("superior_hellspawn", BladeOilConfig.superiorHellspawnOilDamage,
                    BladeOilConfig.superiorHellspawnOilQuality, HELLSPAWN_COLOR, HELLSPAWN_OIL_ENTITIES)));
    ...
    static {
        // TODO: Consider swapping over to entity tags

        HOLY_OIL_ENTITIES.add(EntityType.BOGGED);
        HOLY_OIL_ENTITIES.add(EntityType.DROWNED);
        HOLY_OIL_ENTITIES.add(EntityType.HUSK);
        HOLY_OIL_ENTITIES.add(EntityType.PHANTOM);
        HOLY_OIL_ENTITIES.add(EntityType.SKELETON);
        HOLY_OIL_ENTITIES.add(EntityType.SKELETON_HORSE);
        HOLY_OIL_ENTITIES.add(EntityType.STRAY);
        HOLY_OIL_ENTITIES.add(EntityType.WITHER);
        HOLY_OIL_ENTITIES.add(EntityType.WITHER_SKELETON);
        HOLY_OIL_ENTITIES.add(EntityType.ZOGLIN);
        HOLY_OIL_ENTITIES.add(EntityType.ZOMBIE);
        HOLY_OIL_ENTITIES.add(EntityType.ZOMBIE_HORSE);
        HOLY_OIL_ENTITIES.add(EntityType.ZOMBIE_VILLAGER);
        HOLY_OIL_ENTITIES.add(EntityType.ZOMBIFIED_PIGLIN);

        INSECTOID_OIL_ENTITIES.add(EntityType.BEE);
        INSECTOID_OIL_ENTITIES.add(EntityType.CAVE_SPIDER);
        INSECTOID_OIL_ENTITIES.add(EntityType.ENDERMITE);
        INSECTOID_OIL_ENTITIES.add(EntityType.SILVERFISH);
        INSECTOID_OIL_ENTITIES.add(EntityType.SPIDER);

        DAVY_JONES_OIL_ENTITIES.add(EntityType.AXOLOTL);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.COD);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.DOLPHIN);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.ELDER_GUARDIAN);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.GLOW_SQUID);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.GUARDIAN);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.PUFFERFISH);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.SALMON);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.SQUID);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.TADPOLE);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.TROPICAL_FISH);
        DAVY_JONES_OIL_ENTITIES.add(EntityType.TURTLE);

        ENDSPAWN_OIL_ENTITIES.add(EntityType.ENDERMITE);
        ENDSPAWN_OIL_ENTITIES.add(EntityType.ENDER_DRAGON);
        ENDSPAWN_OIL_ENTITIES.add(EntityType.ENDERMAN);
        ENDSPAWN_OIL_ENTITIES.add(EntityType.SHULKER);

        HANGED_MAN_OIL_ENTITIES.add(EntityType.EVOKER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.ILLUSIONER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.PILLAGER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.PLAYER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.VILLAGER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.VINDICATOR);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.WANDERING_TRADER);
        HANGED_MAN_OIL_ENTITIES.add(EntityType.WITCH);

        RELICT_OIL_ENTITIES.add(EntityType.ALLAY);
        RELICT_OIL_ENTITIES.add(EntityType.BREEZE);
        RELICT_OIL_ENTITIES.add(EntityType.CREAKING);
        RELICT_OIL_ENTITIES.add(EntityType.CREEPER);
        RELICT_OIL_ENTITIES.add(EntityType.GHAST);
        RELICT_OIL_ENTITIES.add(EntityType.SLIME);
        RELICT_OIL_ENTITIES.add(EntityType.SNIFFER);
        RELICT_OIL_ENTITIES.add(EntityType.VEX);
        RELICT_OIL_ENTITIES.add(EntityType.WARDEN);

        HELLSPAWN_OIL_ENTITIES.add(EntityType.BLAZE);
        HELLSPAWN_OIL_ENTITIES.add(EntityType.HOGLIN);
        HELLSPAWN_OIL_ENTITIES.add(EntityType.MAGMA_CUBE);
        HELLSPAWN_OIL_ENTITIES.add(EntityType.PIGLIN);
        HELLSPAWN_OIL_ENTITIES.add(EntityType.PIGLIN_BRUTE);
        HELLSPAWN_OIL_ENTITIES.add(EntityType.STRIDER);
    }
